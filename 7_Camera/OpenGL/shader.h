...
public:
	...
	*/
	...
	void setMat4(const std::string& name, GLboolean tranpose, glm::mat4 matrix) const {
		glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, tranpose, glm::value_ptr(matrix));
	}
